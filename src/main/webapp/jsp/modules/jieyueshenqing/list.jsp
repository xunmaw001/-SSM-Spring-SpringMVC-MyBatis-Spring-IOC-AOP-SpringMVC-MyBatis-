    ...
    <script>
        ...
        function getDataList() {
            http("jieyueshenqing/page", "GET", {
                ...
                jieyuebuTypes: searchForm.jieyuebuTypes,
                zhuguanTypes: searchForm.zhuguanTypes,
                zhurenTypes: searchForm.zhurenTypes,
                wenshudanganTypes: searchForm.wenshudanganTypes,
        ...
        function setDataRow(item, number) {
            ...
            if(
                (window.sessionStorage.getItem('role') == '借阅部领导' && item.jieyuebuTypes == 1 )  //借阅部领导并且借阅部领导审批状态为待审批
                || (window.sessionStorage.getItem('role') == '主管领导' && item.zhuguanTypes == 1 )  //主管领导并且主管领导审批状态为待审批
                || (window.sessionStorage.getItem('role') == '综合部主任' && item.zhurenTypes == 1 )  //主管领导并且主管领导审批状态为待审批
                || (window.sessionStorage.getItem('role') == '文书档案专责人员' && item.wenshudanganTypes == 1 )  //文书档案专责人员并且文书档案专责人员审批状态为待审批
            ...
            if(window.sessionStorage.getItem('role') == '管理员' && item.jieyuebuTypes == 2 && item.zhuguanTypes == 2 && item.zhurenTypes == 2 && item.wenshudanganTypes == 2){
                //修改按钮
                var editBtn = document.createElement('button');
                var editAttr = 'edit(' + item.id + ')';
                editBtn.setAttribute("type", "button");

...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">主管领导管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">主管领导列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">主管领导列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //主管领导手机号
            var zhuguanPhoneCell = document.createElement('td');
            zhuguanPhoneCell.innerHTML = item.zhuguanPhone;
            row.appendChild(zhuguanPhoneCell);


            //主管领导身份证号
            var zhuguanIdNumberCell = document.createElement('td');
            zhuguanIdNumberCell.innerHTML = item.zhuguanIdNumber;
            row.appendChild(zhuguanIdNumberCell);

                //主管领导照片
            var zhuguanPhotoCell = document.createElement('td');
            var zhuguanPhotoImg = document.createElement('img');
            var zhuguanPhotoImgValue = item.zhuguanPhoto;
            if(zhuguanPhotoImgValue !=null && zhuguanPhotoImgValue !='' && zhuguanPhotoImgValue !='null'){
                zhuguanPhotoImg.setAttribute('src', zhuguanPhotoImgValue);
                zhuguanPhotoImg.setAttribute('height', 100);
                zhuguanPhotoImg.setAttribute('width', 100);
                zhuguanPhotoCell.appendChild(zhuguanPhotoImg);
            }else{
                zhuguanPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(zhuguanPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zhuguan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzhuguan", "addzhuguan");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("zhuguan/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){

...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">文书档案专责人员管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">文书档案专责人员管理</li>
                            <li class="breadcrumb-item active">文书档案专责人员列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">文书档案专责人员列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //专责人员手机号
            var wenshudanganPhoneCell = document.createElement('td');
            wenshudanganPhoneCell.innerHTML = item.wenshudanganPhone;
            row.appendChild(wenshudanganPhoneCell);


            //专责人员身份证号
            var wenshudanganIdNumberCell = document.createElement('td');
            wenshudanganIdNumberCell.innerHTML = item.wenshudanganIdNumber;
            row.appendChild(wenshudanganIdNumberCell);

                //专责人员照片
            var wenshudanganPhotoCell = document.createElement('td');
            var wenshudanganPhotoImg = document.createElement('img');
            var wenshudanganPhotoImgValue = item.wenshudanganPhoto;
            if(wenshudanganPhotoImgValue !=null && wenshudanganPhotoImgValue !='' && wenshudanganPhotoImgValue !='null'){
                wenshudanganPhotoImg.setAttribute('src', wenshudanganPhotoImgValue);
                wenshudanganPhotoImg.setAttribute('height', 100);
                wenshudanganPhotoImg.setAttribute('width', 100);
                wenshudanganPhotoCell.appendChild(wenshudanganPhotoImg);
            }else{
                wenshudanganPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(wenshudanganPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("wenshudangan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addwenshudangan", "addwenshudangan");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("wenshudangan/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){

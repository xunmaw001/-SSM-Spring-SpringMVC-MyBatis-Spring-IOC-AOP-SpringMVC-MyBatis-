    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑文书档案专责人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑文书档案专责人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">文书档案专责人员信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="wenshudanganPhone" name="wenshudanganPhone" class="form-control"
                                               onchange="wenshudanganPhoneChickValue(this)"  placeholder="专责人员手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>专责人员身份证号</label>
                                        <input id="wenshudanganIdNumber" name="wenshudanganIdNumber" class="form-control"
                                               onchange="wenshudanganIdNumberChickValue(this)"  placeholder="专责人员身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>专责人员照片</label>
                                        <img id="wenshudanganPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="wenshudanganPhotoupload"
                                               class="form-control-file">
                                        <input name="wenshudanganPhoto" id="wenshudanganPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>性别</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#wenshudanganPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('wenshudanganPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('wenshudanganPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("wenshudangan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addwenshudangan');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function wenshudanganPhoneChickValue(e){
        ...
        function wenshudanganIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                wenshudanganName: "required",
                wenshudanganPhone: "required",
                wenshudanganIdNumber: "required",
                wenshudanganPhoto: "required",
                sexTypes: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                wenshudanganName: "专责人员姓名不能为空",
                wenshudanganPhone: "专责人员手机号不能为空",
                wenshudanganIdNumber: "专责人员身份证号不能为空",
                wenshudanganPhoto: "专责人员照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addwenshudangan = window.sessionStorage.getItem("addwenshudangan");
        if (addwenshudangan != null && addwenshudangan != "" && addwenshudangan != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("wenshudangan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显

                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">档案管理</li>
                            <li class="breadcrumb-item active">档案列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(danganTypesCell);
                ...
                //档案图片
            var danganPhotoCell = document.createElement('td');
            var danganPhotoImg = document.createElement('img');
            var danganPhotoImgValue = item.danganPhoto;
            if(danganPhotoImgValue !=null && danganPhotoImgValue !='' && danganPhotoImgValue !='null'){
                danganPhotoImg.setAttribute('src', danganPhotoImgValue);
                danganPhotoImg.setAttribute('height', 100);
                danganPhotoImg.setAttribute('width', 100);
                danganPhotoCell.appendChild(danganPhotoImg);
            }else{
                danganPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(danganPhotoCell);

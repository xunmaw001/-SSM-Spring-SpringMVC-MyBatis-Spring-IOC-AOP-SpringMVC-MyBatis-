...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">借阅部领导管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">借阅部领导列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">借阅部领导列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //借阅部领导手机号
            var jieyuebuPhoneCell = document.createElement('td');
            jieyuebuPhoneCell.innerHTML = item.jieyuebuPhone;
            row.appendChild(jieyuebuPhoneCell);


            //借阅部领导身份证号
            var jieyuebuIdNumberCell = document.createElement('td');
            jieyuebuIdNumberCell.innerHTML = item.jieyuebuIdNumber;
            row.appendChild(jieyuebuIdNumberCell);

                //借阅部领导照片
            var jieyuebuPhotoCell = document.createElement('td');
            var jieyuebuPhotoImg = document.createElement('img');
            var jieyuebuPhotoImgValue = item.jieyuebuPhoto;
            if(jieyuebuPhotoImgValue !=null && jieyuebuPhotoImgValue !='' && jieyuebuPhotoImgValue !='null'){
                jieyuebuPhotoImg.setAttribute('src', jieyuebuPhotoImgValue);
                jieyuebuPhotoImg.setAttribute('height', 100);
                jieyuebuPhotoImg.setAttribute('width', 100);
                jieyuebuPhotoCell.appendChild(jieyuebuPhotoImg);
            }else{
                jieyuebuPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(jieyuebuPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jieyuebu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjieyuebu", "addjieyuebu");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("jieyuebu/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){

...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">综合部主任管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">综合部主任管理</li>
                            <li class="breadcrumb-item active">综合部主任列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">综合部主任列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //综合部主任手机号
            var zhurenPhoneCell = document.createElement('td');
            zhurenPhoneCell.innerHTML = item.zhurenPhone;
            row.appendChild(zhurenPhoneCell);


            //综合部主任身份证号
            var zhurenIdNumberCell = document.createElement('td');
            zhurenIdNumberCell.innerHTML = item.zhurenIdNumber;
            row.appendChild(zhurenIdNumberCell);

                //综合部主任照片
            var zhurenPhotoCell = document.createElement('td');
            var zhurenPhotoImg = document.createElement('img');
            var zhurenPhotoImgValue = item.zhurenPhoto;
            if(zhurenPhotoImgValue !=null && zhurenPhotoImgValue !='' && zhurenPhotoImgValue !='null'){
                zhurenPhotoImg.setAttribute('src', zhurenPhotoImgValue);
                zhurenPhotoImg.setAttribute('height', 100);
                zhurenPhotoImg.setAttribute('width', 100);
                zhurenPhotoCell.appendChild(zhurenPhotoImg);
            }else{
                zhurenPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(zhurenPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zhuren/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzhuren", "addzhuren");
            window.location.href = "add-or-update.jsp"
        }

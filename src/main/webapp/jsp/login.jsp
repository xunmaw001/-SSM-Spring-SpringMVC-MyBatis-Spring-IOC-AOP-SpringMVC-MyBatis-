        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="借阅部领导" onclick="checkRole('jieyuebu')">&nbsp;借阅部领导
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="主管领导" onclick="checkRole('zhuguan')">&nbsp;主管领导
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="综合部主任" onclick="checkRole('zhuren')">&nbsp;综合部主任
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="文书档案专责人员" onclick="checkRole('wenshudangan')">&nbsp;文书档案专责人员
                        </label>
                    </div>
                </div>
				...
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/jieyuebu/register.jsp'">注册  借阅部领导</button></div>--%>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/zhuguan/register.jsp'">注册  主管领导</button></div>--%>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/zhuren/register.jsp'">注册  综合部主任</button></div>--%>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/wenshudangan/register.jsp'">注册  文书档案专责人员</button></div>--%>

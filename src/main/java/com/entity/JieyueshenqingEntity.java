...
public class JieyueshenqingEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JieyueshenqingEntity() {

	}

	public JieyueshenqingEntity(T t) {
		try {
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @TableField(value = "jieyuebu_time",fill = FieldFill.UPDATE)
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @TableField(value = "zhuguan_time",fill = FieldFill.UPDATE)
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @TableField(value = "zhuren_time",fill = FieldFill.UPDATE)
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @TableField(value = "wenshudangan_time",fill = FieldFill.UPDATE)
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @TableField(value = "jingbanren_time",fill = FieldFill.UPDATE)
    ...
    public String toString() {
        return "Jieyueshenqing{" +
            ...
            ", gongdiangongsi=" + gongdiangongsi +
            ", jieyuebuId=" + jieyuebuId +
            ", jieyuebuTypes=" + jieyuebuTypes +
            ", jieyuebuContent=" + jieyuebuContent +
            ", jieyuebuTime=" + jieyuebuTime +
            ", zhuguanId=" + zhuguanId +
            ", zhuguanTypes=" + zhuguanTypes +
            ", zhuguanContent=" + zhuguanContent +
            ", zhuguanTime=" + zhuguanTime +
            ", zhurenId=" + zhurenId +
            ", zhurenTypes=" + zhurenTypes +
            ", zhurenContent=" + zhurenContent +
            ", zhurenTime=" + zhurenTime +
            ", wenshudanganId=" + wenshudanganId +
            ", wenshudanganTypes=" + wenshudanganTypes +
            ", wenshudanganContent=" + wenshudanganContent +
            ", wenshudanganTime=" + wenshudanganTime +
            ", jingbanren=" + jingbanren +
            ", jingbanrenTime=" + jingbanrenTime +

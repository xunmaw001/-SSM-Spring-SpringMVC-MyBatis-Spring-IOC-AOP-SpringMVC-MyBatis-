...
public class WenshudanganEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public WenshudanganEntity() {

	}

	public WenshudanganEntity(T t) {
		try {
    ...
    public String toString() {
        return "Wenshudangan{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", wenshudanganName=" + wenshudanganName +
            ", wenshudanganPhone=" + wenshudanganPhone +
            ", wenshudanganIdNumber=" + wenshudanganIdNumber +
            ", wenshudanganPhoto=" + wenshudanganPhoto +
            ", sexTypes=" + sexTypes +

...
public class ZhuguanEntity<T> implements Serializable {
     ...
     * 主管领导手机号
     */
    @TableField(value = "zhuguan_phone")
     ...
     * 主管领导身份证号
     */
    @TableField(value = "zhuguan_id_number")
     ...
     * 主管领导照片
     */
    @TableField(value = "zhuguan_photo")
    ...
    public String toString() {
        return "Zhuguan{" +
            ...
            ", zhuguanPhone=" + zhuguanPhone +
            ", zhuguanIdNumber=" + zhuguanIdNumber +
            ", zhuguanPhoto=" + zhuguanPhoto +
            ", sexTypes=" + sexTypes +
